            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="payments_co_status_af6720_idx",
                    )
                ],
            },
        ),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("business",),
                        name="payments_connected_account_business_unique",
                    ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="communications.publicdocumentlink",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["business", "invoice", "status"],
                        name="payments_in_busines_e3287c_idx",
                    ),
                    models.Index(
                        fields=["status", "expires_at"],
                        name="payments_in_status_87cae0_idx",
                    ),
                ],
                "constraints": [
                    models.CheckConstraint(
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            models.Q(
                                ("completed_at__isnull", False), ("status", "completed")
                            ),
                            models.Q(
